...
Screenshots 1–5 are the real settings window (940×550 points captured at 2x) placed on the brand-blue gradient used by the website, with a one-line white caption at the top; 6–10 are the effect itself rendered at 1920×1248 and placed on the same gradient. The desktop in every image is the app's bundled preview wallpaper (`Sources/MacbookDuo/Resources/PreviewWallpaper.jpg`) with the app's own title and dock drawn over it; no real desktop appears in any screenshot or preview.
